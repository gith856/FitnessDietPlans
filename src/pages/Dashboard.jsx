    ...
    return (
        <div className='bg-gray-200 min-h-screen p-6'>
            ...
            <div className='grid md:grid-cols-3 gap-4 max-w-6xl mx-auto'>
                {bodyType.map((item) => (
                    <div key={item.name} onClick={()=>handleSelect(item.name)} className='bg-white p-6 rounded-xl text-center shadow-lg  hover:scale-105 transition-all cursor-pointer'>
